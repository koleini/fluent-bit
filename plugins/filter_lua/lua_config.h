...
#define LUA_WINDOW          "_window"
#define LUA_WINDOW_INFO     "_window_info"
#define LUA_WINDOW_HEAD     "head"
#define LUA_WINDOW_TAIL     "tail"
#define LUA_WINDOW_SIZE     "size"
...
struct lua_filter {
    ...
    int    window;             /* window size for input buffering */
